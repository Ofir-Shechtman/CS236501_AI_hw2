...
class Player(AbstractPlayer):
    def __init__(self, game_time, penalty_score):
        ...
        self.minimax = MiniMax(self.utility, self.succ, self.make_move, self.goal)
        self.state = None
    ...
    @staticmethod
    def utility_component1(state, turn):
        return state.players_score[0] - state.players_score[1]

    @staticmethod
    def utility_component2(state: State, turn):
    ...
    @staticmethod
    def utility_component3(state: State, turn):
